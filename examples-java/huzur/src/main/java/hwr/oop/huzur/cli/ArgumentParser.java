...
final class ArgumentParser {
  ...
  public ArgumentParser(Supplier<NewGameUseCase> newGameUseCase, Supplier<PlayOnGameUseCase> playOnGameUseCase,
                        Supplier<PickupStackOnGameUseCase> pickupStackOnGameUseCase, Supplier<GameStateQuery> gameStateQuery) {
    this.commands = List.of(new HelpCommand(),
